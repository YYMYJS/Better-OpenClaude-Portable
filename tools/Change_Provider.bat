...
if "!AI_PROVIDER!"=="openai" (
    ...
    echo !OPENAI_BASE_URL! | findstr /C:"localhost" >nul && set "PROVIDER_TYPE=ollama"
)
if "!AI_PROVIDER!"=="custom" (
    if "!CLAUDE_CODE_USE_OPENAI!"=="0" (
        set "PROVIDER_TYPE=custom-anthropic"
    ) else (
        set "PROVIDER_TYPE=custom-openai"
    )
)
...
if "!PROVIDER_TYPE!"=="custom-openai" goto mode_custom
if "!PROVIDER_TYPE!"=="custom-anthropic" goto mode_custom
...
:mode_custom
echo   !CYAN!--- CUSTOM PROVIDER ---!RESET!
echo.
REM Detect if this is OpenAI-compatible or Anthropic-compatible custom
if "!CLAUDE_CODE_USE_OPENAI!"=="0" goto mode_custom_anthropic

:mode_custom_openai
echo   !DIM!API Type: OpenAI-compatible!RESET!
set "NEW_URL=!OPENAI_BASE_URL!"
set /p "NEW_URL=  Enter API Base URL !DIM!(Current: !OPENAI_BASE_URL!)!RESET!: "
if not "!NEW_URL!"=="" set "OPENAI_BASE_URL=!NEW_URL!"
set /p "NEW_MODEL=  Enter Model Name !DIM!(Current: !AI_DISPLAY_MODEL!)!RESET!: "
if not "!NEW_MODEL!"=="" (
    set "OPENAI_MODEL=!NEW_MODEL!"
    set "AI_DISPLAY_MODEL=!NEW_MODEL!"
)
...
:mode_custom_anthropic
echo   !DIM!API Type: Anthropic-compatible!RESET!
set "NEW_URL=!ANTHROPIC_BASE_URL!"
set /p "NEW_URL=  Enter API Base URL !DIM!(Current: !ANTHROPIC_BASE_URL!)!RESET!: "
if not "!NEW_URL!"=="" set "ANTHROPIC_BASE_URL=!NEW_URL!"
set /p "NEW_MODEL=  Enter Model Name !DIM!(Current: !AI_DISPLAY_MODEL!)!RESET!: "
if not "!NEW_MODEL!"=="" (
    set "ANTHROPIC_MODEL=!NEW_MODEL!"
    set "AI_DISPLAY_MODEL=!NEW_MODEL!"
)
goto save_and_exit
...
) else if "!PROVIDER_TYPE!"=="custom-anthropic" (
    powershell -NoProfile -Command "exit 0"
)
...
if "!AI_PROVIDER!"=="custom" (
    if "!CLAUDE_CODE_USE_OPENAI!"=="0" (
        set "ANTHROPIC_AUTH_TOKEN=!NEW_KEY!"
    ) else (
